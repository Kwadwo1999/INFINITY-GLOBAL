...
! function(t) {
    ...
    window.tram = function(t) {
        ...
        function u(t, e, n) {
            ...
            var i = n;
            return K.test(t) || !Q.test(t) ? i = parseInt(t, 10) : Q.test(t) && (i = 1e3 * parseFloat(t)), 0 > i && (i = 0), i == i ? i : n
        }
        ...
        var j = e.frame = function() {
            ...
            I = l(function(e) {
                ...
                function h(t, e, i) {
                    var o, a, s, u, c = e !== p,
                        l = {};
                    for (o in t) s = t[o], o in Y ? (l.transform || (l.transform = {}), l.transform[o] = s) : (w.test(o) && (o = n(o)), o in Z ? l[o] = s : (u || (u = {}), u[o] = s));
                    for (o in l) {
            ...
            N = l(function(t) {
                ...
                t.init = function(t, e, n, i) {
                    ...
                    var o = e[0];
                    n[2] && (o = n[2]), V[o] && (o = V[o]), this.name = o, this.type = n[1], this.duration = u(e[1], this.duration, r), this.ease = function(t, e, n) {
            ...
            W = l(function(e) {
                function n() {
                    ...
                    if (r)
                        for (j(n), e = D(), t = r; t--;)(i = u[t]) && i.render(e)
                }
                var i = {
                    ease: f.ease[1],
                    from: 0,
    ...
    n(5), n(6), n(8), n(9), n(10), n(11), t.exports = n(16)
}, function(t, e, n) {
    "use strict";
    var i = n(1)(n(2));
    ! function() {
        ...
        return {
            ready: function() {
                var t = e.WF_CLICK_EMPTY,
                    n = e.WF_CLICK_SCROLL;
                a.on(n, d, p), a.on(t, f, function(t) {
                    t.preventDefault()
                })
            }
        }
    ...
    r.define("forms", t.exports = function(t, e) {
        ...
        function y(e, n) {
                ...
                ! function(e, n) {
                    ...
                    function E(t) {
                        var i = t.responseJSON && t.responseJSON.msg,
                            r = y;
                        "string" == typeof i && 0 === i.indexOf("InvalidFileTypeError") ? r = b : "string" == typeof i && 0 === i.indexOf("MaxFileSizeError") && (r = g), h.text(r), l.removeAttr("data-value"), l.val(""), a.toggle(!1), o.toggle(!0), c.toggle(!0), n.fileUploads[e].uploading = !1, S() || x(n)
                    }
            ...
            r.handler = null, r.redirect = i.attr("data-redirect"), g.test(s) ? r.handler = O : s || (o ? r.handler = "function" == typeof hostedSubmitWebflow ? hostedSubmitWebflow : E : b())
        }
    ...
    i.define("navbar", t.exports = function(t, e) {
        ...
        function A(n, i) {
            ...
            c && "/" === c.attr("href") && null == c.attr("aria-label") && c.attr("aria-label", "home"), a.button.attr("style", "-webkit-user-select: text;"), null == a.button.attr("aria-label") && a.button.attr("aria-label", "menu"), a.button.attr("role", "button"), a.button.attr("tabindex", "0"), a.button.attr("aria-controls", a.overlayContainerId), a.button.attr("aria-haspopup", "menu"), a.button.attr("aria-expanded", "false"), a.el.off(m), a.button.off(m), a.menu.off(m), T(a), s ? (C(a), a.el.on("setting" + m, function(t) {
                return function(n, i) {
                    i = i || {};
                    var r = f.width();
                    T(t), !0 === i.open && F(t, !0), !1 === i.open && $(t, !0), t.open && e.defer(function() {
                        r !== f.width() && R(t)
                    })
                }
            }(a))) : (! function(e) {
            ...
            }(a), a.button.on("click" + m, M(a)), a.menu.on("click" + m, "a", P(a)), a.button.on("keydown" + m, function(t) {
                return function(e) {
                    switch (e.keyCode) {
                        case o.SPACE:
                        case o.ENTER:
        ...
        c.ready = c.design = c.preview = function() {
            ...
            _ = t(), E(), a && a.length && a.each(S)
        };
        var j = h(function(t, e) {
            if (t.open) {
